...
def numToWords(num)
  ...
  def thousand(a, b, c, d, e=0, f=0) # a = ones, b = tens, c = hundreds, d = one thousands, e = ten thousands, f = hundred thousands
    thousand = "thousand"
    return ones(d) + " " + thousand if (a + b + c + e + f) == 0
    return ones(d) + " " + thousand + " and " + ones(a) if (b + c + e + f) == 0
    return ones(d) + " " + thousand + " and " + tens(b) if (a + c + e + f) == 0
    return ones(d) + " " + thousand + " and " + teens(a) if (b == 1) && (c + e + f == 0)
    return ones(d) + " " + thousand + " and " + tens(b) + " " + ones(a) if (c + e + f == 0)
    return ones(d) + " " + thousand + " " + hundred(a, b, c) if (e == 0) && (f == 0)

    return tens(e) + " " + thousand if (a + b + c + d + f) == 0
    return tens(e) + " " + thousand + " and " + ones(a) if (b + c + d + f) == 0
    return tens(e) + " " + thousand + " and " + tens(b) if (a + c + d + f) == 0
    return tens(e) + " " + thousand + " and " + teens(a) if (b == 1) && (c + d + f == 0)
    return tens(e) + " " + thousand + " and " + tens(b) + " " + ones(a) if (c + d + f == 0)
    return tens(e) + " " + thousand + " " + hundred(a, b, c) if (d + f == 0)

    return teens(d) + " " + thousand if (f + a + b + c == 0) && (e == 1)
    return teens(d) + " " + thousand + " and " + ones(a) if (e == 1) && (b + c + f) == 0
    return teens(d) + " " + thousand + " and " + tens(b) if (e == 1) && (a + c + f) == 0
    return teens(d) + " " + thousand + " and " + teens(a) if (e + b == 2) && (c + f == 0)
    return teens(d) + " " + thousand + " and " + tens(b) + " " + ones(a) if (c + f == 0)
    return teens(d) + " " + thousand + " " + hundred(a, b, c) if (e == 1) && (f == 0)

    return tens(e) + " " + ones(d) + " " + thousand if (a + b + c + f) == 0
    return tens(e) + " " + ones(d) + " " + thousand + " and " + ones(a) if (b + c + f) == 0
    return tens(e) + " " + ones(d) + " " + thousand + " and " + tens(b) if (a + c + f) == 0
    return tens(e) + " " + ones(d) + " " + thousand + " and " + teens(a) if (b == 1) && (c + f == 0)
    return tens(e) + " " + ones(d) + " " + thousand + " and " + tens(b) + " " + ones(a) if  (c + f == 0)
    return tens(e) + " " + ones(d) + " " + thousand + " " + hundred(a, b, c) if (f == 0)
